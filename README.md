...
- **UTM parameters** — whatever you type gets appended to each article's link (e.g. `utm_source=pinterest&utm_medium=social&utm_campaign=akash`). Leave it blank for no UTM parameters at all.
